...
_PRODUCTS = ["Formula Exclusiva","Laciador","Gotero","Gotika"]
...
{"action":"A salon in Miami found their solution for dry hair with Laciador","city":"Miami, FL","flag":"🇺🇸","product":"Laciador"}"""
